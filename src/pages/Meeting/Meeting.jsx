...
const Meeting = () => {
    return (
        <div>
            <Helmet>
                <title>Shine Events | Meeting</title>
            </Helmet>
            <Navbar></Navbar>
                    ...
                    <div className="-mx-4 flex flex-wrap lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <p className="my-5">
                                    We'd love to hear from you! Whether you have a question, feedback, or just want to say hello, don't hesitate to get in touch. Our team is here to assist you in any way we can. Feel free to reach out via the contact form below, send us an email, or give us a call. Your thoughts and inquiries are important to us, and we promise to respond as promptly as possible. Thank you for considering us as your point of contact – we look forward to connecting with you!
                                </p>
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">(+88) 01714-443322</p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    <div
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">info@shineEvent.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
